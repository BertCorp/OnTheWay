IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "p1khnkwr"

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Intercom
  # "security" configuration page.
  #
  config.api_secret = "KC65qWYrEDffhS7v_BJDiDuCaaUDN2-YyvThR3MY"
  ...
  #
  config.api_key = "1b06b2aa2d2ebf885f6a18a7fefbe8d81e7f7a09"
  ...
  #
  config.user.model = Proc.new { Company }
