# RailsAdmin config file. Generated on June 04, 2013 17:20
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['On The Way', 'Admin']
  ...
  # config.excluded_models = ['Appointment', 'Company', 'Customer', 'Provider']

  # Include specific models (exclude the others):
  # config.included_models = ['Appointment', 'Company', 'Customer', 'Provider']
