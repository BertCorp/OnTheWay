          ...
          if ( status === 'OK' ) {
            ...
            self.search({ 'location': latlng }, function(results, status) {
              if ( status === 'OK' ) {
                ...
                self.displayDirections({ 'origin': $('#from').val(), 'destination': $('#to').val(), 'travelMode': google.maps.DirectionsTravelMode.DRIVING }, { 'panel': document.getElementById('directions_list')}, function(response, status) {
